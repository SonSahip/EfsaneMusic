...
async def start(_, message: Message):
                ...
                "https://i.ibb.co/HqxsQ59/Sahip-Music.png",
                caption=(f"""**Merhaba {message.from_user.mention} 🎵\nBen {bot}!\nSesli sohbetlerde müzik çalabilen botum. Ban yetkisiz, Ses yönetimi yetkisi verip, Asistanı gruba ekleyiniz.\n\nDüzen Tasarım [Sahip Müzik 🎙️](https://t.me/SahipMuzikBotSupport).**"""),
         reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Grubuna Ekle ❱ ➕", url=f"https://t.me/SahipMuzikBot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/SahipMusicBotAsistan"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/SahipMuzikBotSupport"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/SahipMuzikBotCHANNEL"
                    )
                ]
      ...
      reply_markup=InlineKeyboardMarkup(
             [
                 [
                     ...
                     InlineKeyboardButton(
                         "⚙ Geliştirici", url="https://t.me/SonSahip")
                 ]
             ]
         )
    )
